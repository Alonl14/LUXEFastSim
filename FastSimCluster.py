...
np.save(outer_trainer.outputDir+'Val_D_losses_out.npy', outer_trainer.Val_D_Losses)
np.save(inner_trainer.outputDir+'G_losses_in.npy', inner_trainer.G_Losses)
np.save(outer_trainer.outputDir+'G_losses_out.npy', outer_trainer.G_Losses)
np.save(inner_trainer.outputDir+'Val_G_losses_in.npy', inner_trainer.Val_G_Losses)
np.save(outer_trainer.outputDir+'Val_G_losses_out.npy', outer_trainer.Val_G_Losses)
