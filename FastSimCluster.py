...
def main():
    """
    Main function to run the FastSim training process.
    It initializes trainers for different regions, runs the training,
    and saves the logs.
        """
    # ------------------------------------------------------------------ #
    # 0.  CLI                                                             #
...
if __name__ == "__main__":
    main()
    print("FastSimCluster.py finished successfully.")
